...
const BreakdownManagementDriver3 = ({route}) => {
          ...
          <View style={styles.normal}>
            <Text style={styles.text}>Update new Vehicle Details</Text>
              ...
              <View style={styles.smallbox}>
                ...
                <Text style={styles.text1}>Validated</Text>
              </View>
...
<TouchableOpacity   onPress={() => navigation.navigate('BreakdownManagementDriver4', {
...
export default BreakdownManagementDriver3;
